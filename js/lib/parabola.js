...
var funParabola = function(element, target, options) {
	...
	*/
	...
	var defaults = {
		...
		speed: 3600, // 默认 166.67 每帧移动的像素大小，每帧（对于大部分显示屏）大约16~17毫秒
		curvature: 0.003,  // 实际指焦点到准线的距离，你可以抽象成曲率，这里模拟扔物体的抛物线，因此是开口向下的
		progress: function() {},
		complete: function() {}
	};
	...
	if (element && target && element.nodeType == 1 && target.nodeType == 1) {
		...
		exports.position = function() {
			...
			if (moveStyle == "margin") {
				...
				element.style[moveStyle] = "translate(0, 0) scale(0,0)";
			}
		...
		exports.move = function() {
			...
			var step = function() {
				...
				if (moveStyle == "margin") {
					...
					element.style[moveStyle] = "translate("+ [x + "px", y + "px"].join() +") scale(1,1)";
				}
